...
OBJS = general.o evb_mod.o qmdff.o lm_module.o debug.o h2co_mod.o \
       pbc_mod.o fftw_mod.o xtb_mod.o inter_mace.o inter_uma.o \
       \
       ...
       egrad_pgfn.o egrad_mace.o mace_init.o egrad_uma.o uma_init.o \
       \
